...
-- Run this file as-is without wrapping in BEGIN/COMMIT or DO blocks.
-- If running via Supabase SQL editor, execute each section separately if needed.
-- ============================================================================
...
-- These can run in a transaction since they're not CONCURRENTLY
